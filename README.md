...
Hi, I'm **Labdhi Jain**, a final-year Software Engineering student at **VIT-AP** with a strong interest in **Full-stack development enhanced by Artificial Intelligence**.


My work includes extensive experience architecting production-ready web systems utilizing Next.js, FastAPI, and TypeScript, while implementing LLM workflows, computer vision, and real-time AI pipelines leveraging cloud-native architecture and secure authentication.


```txt
Name        → Labdhi Jain
Education   → Int. M.Tech SE, VIT-AP (2023–2028)
CGPA        → 8.83 / 10.0
Location    → Jodhpur, India 🇮🇳
Focus       → Full Stack Development · AI Engineering · Computer Vision
Status      → Open to Research, Internship, SDE, & AI Engineer Roles 🟢
```
...
[![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=labdhi-jain\&theme=tokyo-night)](https://github.com/labdhi-jain)
...
### *"Technology becomes truly transformative only when it works in tandem with human creativity."*
